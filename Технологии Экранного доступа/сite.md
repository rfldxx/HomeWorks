...
### Описание сайта
Я сделал текстовый "сайт" с сслыками, который полностью отрисовывает своё содержимое в элементе HTML5 Canvas. (Не используется никаких дополнительных библиотек, т.е. можно просто запустить в браузере. Всё как полагается в одном файле: unreadable_cite.html.)

Сайт собирается из текстового описания (в самом конце [пример](#пример)). В тексте можно создавать ссылки на другие страницы этого сайта (подобно markdown) и преходить по ним с помощью нажатия мышкой. Доступные ссылки окрашены в синий, не доступные - в красный. При наведении курсора на ссылку тип курсора становится `"pointer"`.

Также на страницах доступен вертикальный скрол, с помощью: колесика мыши и стрелок вверх/вниз.

Ссылка на код cайта: [unreadable_cite.html](unreadable_cite.html)
